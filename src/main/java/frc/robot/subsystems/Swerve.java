...
import frc.robot.subsystems.SwerveModuleIOKrakenDFalconT;
...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        ...
        SwerveModuleIOKrakenDFalconT m0 = new SwerveModuleIOKrakenDFalconT(0, Constants.Swerve.Mod0.constants);

        SwerveModuleIOKrakenDFalconT m1 = new SwerveModuleIOKrakenDFalconT(1, Constants.Swerve.Mod1.constants);

        SwerveModuleIOKrakenDFalconT m2 = new SwerveModuleIOKrakenDFalconT(2, Constants.Swerve.Mod2.constants);

        SwerveModuleIOKrakenDFalconT m3 = new SwerveModuleIOKrakenDFalconT(3, Constants.Swerve.Mod3.constants);

        mSwerveMods = new SwerveModule[] {
                new SwerveModule(m0, 0),
                new SwerveModule(m1, 1),
                new SwerveModule(m2, 2),
                new SwerveModule(m3, 3)
        };
    ...
    public void resetModulesToAbsolute() {
        for (SwerveModule mod : mSwerveMods) {
            mod.updateTalonEncoderToAbsoluteValueWithOffsert();
        }
    }
